    ...
    <div className="flex min-h-[550px] w-[min(100%,24rem)] sm:w-full max-w-6xl mx-auto rounded-2xl overflow-hidden shadow-2xl bg-card flex-col lg:flex-row">
      ...
      <div className="lg:w-1/2 bg-gradient-to-br from-amber-500 to-orange-400 p-4 sm:p-8 lg:p-12 flex flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-4 lg:space-y-6 text-center lg:text-left">
          ...
          <p className="text-amber-100 max-w-sm mx-auto lg:mx-0 text-sm lg:text-base">
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 sm:space-y-5">
        ...
        <Button
          type="submit"
          className="w-full h-10 sm:h-11 bg-gradient-to-r from-amber-400 to-orange-400 hover:from-amber-500 hover:to-orange-500 text-white rounded-xl font-medium transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-amber-400/20"
        >
